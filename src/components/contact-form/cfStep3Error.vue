<template>
  <div id="cf3">
    ...
    <p style="text-align:center;">
      Your e-mail could not be sent. Please check your Internet connection and try again.
      <br />
      <br />If the problem persists, please send us an email to:
      <a href="mailto:phil@uxstack.design" style="font-weight:bold">phil@uxstack.design</a
      >.
    </p>
    <div class="step-back">
      <BackButton class="error-back" @click.native="goToCfStep('cf2')"></BackButton>
    </div>
  </div>
</template>
